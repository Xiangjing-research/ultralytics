...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, MultispectralDetectionModel, MultispectralSegmentationModel, OBBModel, PoseModel, SegmentationModel, WorldModel
