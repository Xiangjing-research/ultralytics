...
from ultralytics.nn.modules import (
    ...
    CBLinear,
    Silence,
    Add, Add2,Bridge, DFMSDABlock, C2f_GhostConv, C2f_GhostNetV2,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            DWConvTranspose2d,
            C3x,
            RepC3,C2f_GhostNetV2, GSConv, C2f_RefConv, C2f_Faster_PConv, C2f_RepViTBlock
        }:
            c1, c2 = ch[f], args[0]
            if f == -2:
                c1 = 3
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_GhostConv, C2f_GhostNetV2, C2f_RefConv, C2f_Faster_PConv,C2f_RepViTBlock}:
...
class MultispectralDetectionModel(BaseModel):
    ...
    def _predict_once(self, x, profile=False, visualize=False):
        ...
        Args:
            x (torch.Tensor): The input tensor to the model.
            ir (torch.Tensor): The input ir tensor to the model.
            profile (bool):  Print the computation time of each layer if True, defaults to False.
            visualize (bool): Save the feature maps of the model if True, defaults to False.
