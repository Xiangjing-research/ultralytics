...
if __name__ == '__main__':
    ...
    model_info(model, detailed=False, verbose=True, imgsz=160) #Model summary: 37 layers, 93184 parameters, 93184 gradients
    model = Conv(c1=64, c2=128, k=3, s=2)
    model_info(model, detailed=False, verbose=True, imgsz=160)
